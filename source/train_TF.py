...
if __name__ == '__main__':
    train_images, train_images_gt, validation_images, validation_images_gt = load_images(1000)
    ...
    with tf.Session() as session:
        ...
        train_batch(train_images, train_images_gt, validation_images, validation_images_gt, epochs=1, batch_size=10)
